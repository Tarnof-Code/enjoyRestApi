...
- **Chambres** (hébergement séjour) : CRUD `/sejours/{id}/chambres`, types `ENFANT` / `EQUIPE`, identifiant unique par séjour, référents (enfants only) — détail : `docs/ai/documentation-api-rest.md`. ⚠️ Front : aligner `api.d.ts`.
